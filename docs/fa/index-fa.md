...
**سورس کامل فعال‌ساز محصولات مایکروسافت در [این آدرس][5]**
...
- سورس کامل روش‌های  فعال‌ساز محصولات مایکروسافت در [این ریپو][5] هستش، میتونید از اونجا نسخه آپدیت شده‌ی آموزش رو بخونید.

  - ذاتا واسه‌ی غریبه نیست، اونم خودم می‌نویسمش همیشه :)
:::
