...
![17532993550521976748763147702843](https://github.com/user-attachments/assets/acea2360-7f44-4da8-9345-d96c5d4e0eec)
...
![17532998751966881502819695183773](https://github.com/user-attachments/assets/682d931a-d8e0-4fa1-890d-f03e36a4a255)
...
بعدش دیلر از نفر سمت چپش شروع می‌کنه و به هر بازیکن **۲ کارت شخصی** می‌ده. این کارت‌هارو فقط خودت می‌تونی ببینی و قراره باهاشون معجزه کنی پس نذار اطرافیان گردنشون رو مث زرتفه دراز کنن سمت‌ کارت‌های تو 😁
...
![17532997816875988095675872267469](https://github.com/user-attachments/assets/c4d6f753-43f5-45ec-b489-54a1ad87b5c8)
...
این مرحله صرفا برا اینه که همه یه دور چک بکنن اکه قراره شرط همین اول افزایش پیدا بکنه افزایش بدن وگرنه تو این دور اول نه کسی از بازی بیرون رفته ینی `Fold` کرده نه حتی `raise` کرده الکی رو هوا.
...
![17533002649127640480548332219462](https://github.com/user-attachments/assets/d8fdbc83-6264-4bf8-82e4-b4a33cf8fa6f)
...
### مرحله سوم و چهارم – The Turn / The River
...
تو هر مرحله از شرط‌بندی، ما می‌تونیم نسبت به کارت‌هایی ک گیرمون اومده رفتار کنیم. خیلی مهمه که بدونیم بهترین رفتار تو مراحل چیه و الکی **fold** نکنیم یا بالعکس همش بولوف نزنیم
...
حالا اصل کاری! باید از ۷ تا کارتی که داری (۲ تا تو دست خودت، ۵ تا رو زمین)، **بهترین ترکیب ۵ تایی** ممکن رو بسازی. بهت می‌گم ترکیب‌هارو. من به ترتیب از کم‌ارزش‌ترین ترکیب‌ می‌نویسم تا در نهایت برسم به با ارزش‌ترین اون ها.

<br/> 

![17532995824292527896463961022918](https://github.com/user-attachments/assets/71184a4d-2a1a-41cf-a283-bbe4a2c9a579)

<br/>

![17532932499587529923899439476633](https://github.com/user-attachments/assets/95720aaf-9beb-41f6-98a2-16d47bcb1e14)
...
توضیحاتی که اینجا گفتم بیشتر مربوط به بازی‌های آنلاینه، مثل بازی در اپلیکیشن پلاتو یا هر پلتفرم دیگه. توی بازی‌های واقعی، همه‌چی یه درجه پیچیده‌تر و جدی‌تر میشه. اونجا باید بتونی حرکات بدن بقیه رو بخونی، از نگاهشون، صداشون، لرزش دست یا حتی نحوه گرفتن کارتاشون بفهمی دارن بلوف می‌زنن یا نه. کلی جزئیات ریز هست که فقط با تجربه و تمرین می‌تونی توش ماهر بشی – چیزی که تو بازی آنلاین اصلاً دیده نمی‌شه ✋🏿🩶♥️♠️♦️♣️

<hr/><br/> 

تا اینجای آموزش نوشته‌های نیما بود، واسه اینکه می‌خواستم تو سایت بذارمش و دیگه پست تلگرامی نبود و محدودیت کاراکتر نداشتیم از ai خواستم یکی دو بخش بهش اضافه بکنه، از اینجا به بعد همش نوشته‌های جمنای هست
...
::: tip 🎯 استراتژی بلوف / Bluff Strategy و Pot Odds
...
خب حالا:
- احتمال اینکه توی کارت بعدی اون پیک بیاد چقدره؟ تقریباً 9 کارت پیک از 47 کارت مونده = یعنی حدود **19٪**
- حالا Pot Odds چنده؟  
  تو باید 20 تا بدی که شانس ببری 100 تا (پات)، پس 20 / (100+20) = **16.6٪**

✅ چون **19٪ > 16.6٪**، ادامه دادن به صرفه‌ست! چون احتمال موفقیتت از ریسکت بیشتره.

⛔ ولی اگه قرار بود 50 تا ژتون بدی، Pot Odds می‌شد 50 / (100+50) = **33٪** که با اون 19٪ احتمال برد نمی‌ارزه و باید **Fold** بدی.

پس همیشه فقط احساسی بازی نکن، یه چرتکه تو ذهنت بنداز.

<br/>

### 🎭 استراتژی بلوف (Bluffing) – بلوف حرفه‌ای، نه خالی‌بندی!

بلوف یعنی نشون بدی دستت خیلی قویه، در حالی که ممکنه هیچی نداشته باشی 😏 ولی این کار هم تاکتیک داره:

#### ❌ کی بلوف نزنیم:
- اگه طرف مقابل **زیاد کال می‌کنه**، احتمالاً بلوف رو نمی‌فهمه یا براش مهم نیست.
- اگه ۲ نفر یا بیشتر تو پات هستن، بلوف سخت‌تر جواب می‌ده.
- اگه خودت زیاد بلوف کردی تو دستای قبل، حواست باشه که **لو رفتی**!

#### ✅ کی بلوف بزنیم:
- اگه تو زمین کارت‌هایی هستن که دست قوی نشون می‌دن (مثلاً 3 تا پیک روی میز)، ولی هیچ‌کس رئیز نکرده، می‌تونی بلوف بزنی که Flush شدی.
- وقتی از موقعیت خوب (مثلاً آخرین نفری که بازی می‌کنه) اقدام می‌کنی.
- وقتی که هیچی نداری ولی از قبل داری **داستان می‌سازی**. مثلاً توی Flop فقط Call کردی، ولی تو Turn و River یه‌هو Raise زدی. اون‌وقت شاید بقیه فکر کنن تو آروم داشتی Flush یا Straight می‌ساختی.

#### 🔁 Semi-Bluff چیه؟

وقتی واقعاً یه دست ناقص داری، مثلاً 4 تا کارت به Flush، ولی هنوز کامل نشده — و با این حال بلوف می‌زنی، بهش می‌گن **Semi-Bluff**. چون هم شانس برد واقعی داری، هم شاید با بلوف بقیه رو فراری بدی. این از بهترین تکنیک‌هاست واسه بازیکن حرفه‌ای.

<br/>

به طور خلاصه، بلوف یه هنر واقعیه، نه یه شیرین‌کاری. اگه به‌جا ازش استفاده کنی، حتی با دست خالی هم می‌تونی میز رو جمع کنی 😎🃏
