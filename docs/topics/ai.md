...
# هوش‌های مصنوعی مختص برنامه‌نویسی

اگه دنبال یه لیست از مدل‌های هوش‌مصنوعی برای استفاده‌های عادی و روتین هستی پیشنهاد می‌کنم به [این لیست](./ai-tg) سر برنی.

<br/>

<Badge type="info" text="💡 فهرستی برگزیده از" /> **ابزارهای برنامه‌نویسی مبتنی بر هوش مصنوعی** شامل ویرایشگرهای کد هوشمند، موتورهای تکمیل خودکار کد، دستیارهای بازبینی کد، ابزارهای بازمهندسی هوشمند، مدل‌های زبانی بزرگ برای توسعه‌دهندگان
