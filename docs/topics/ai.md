...
head:
  - - meta
    - name: keywords
      content: جمنای, گوگل استودیو, چت جی‌پی‌تی, کلاد, دیپ‌سیک, کیمی, آرنا, میسترال, گروک
---

# ابزارهای برنامه‌نویسی مبتنی بر هوش مصنوعی

اگه دنبال یه لیست از مدل‌ها برای استفاده روتین هستی پیشنهاد می‌کنم [این لیست](./ai-daily) رو چک کنی.

<br/>
<p align="center">
  <img src="/ai/ai-9.png" alt="AI-9" width="1408px" />
</p><br/>


<Badge type="info" text="💡 فهرستی برگزیده از" /> **ابزارهای برنامه‌نویسی مبتنی بر هوش مصنوعی** شامل ویرایشگرهای کد هوشمند، موتورهای تکمیل خودکار کد، دستیارهای بازبینی کد، ابزارهای بازمهندسی هوشمند، مدل‌های زبانی بزرگ برای توسعه‌دهندگان و ابزارهایی که زبان طبیعی را به کد تبدیل می‌کنند.

این فهرست برای توسعه‌دهندگان، تیم‌ها، پژوهشگران و علاقه‌مندان به فناوری گردآوری شده که به دنبال بهره‌گیری از هوش مصنوعی در فرآیندهای مهندسی نرم‌افزار هستند.
