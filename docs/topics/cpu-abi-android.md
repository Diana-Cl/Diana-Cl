...
- **`arm64-v8a – arm64 – aarch64`** →  
 پردازنده‌های ARM جدیدتر ۶۴بیتی

- **`armeabi-v7a – arm – aarch`** →  
 پردازنده‌های ARM قدیمی‌تر ۳۲بیتی

- **`x86`** →   
مخصوص دستگاه‌های اینتل ۳۲بیتی (در حال انقراض)

- **`x86_64`** →   
مخصوص دستگاه‌های اینتل ۶۴بیتی (خیلی 🦖)
