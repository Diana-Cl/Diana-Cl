...
با این DNS گروه `Xstack` که من تعیین کردم و هم‌چنین DNS گروه `شکن` روی بعضی نت‌ها یوتیوب و اینستاگرام و توئیتر بدون مشکل بالا میان، و هزاران سایتی که تحت تحریم ظالمانه 🤣 از طرف ایران هستن.
