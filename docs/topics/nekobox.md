...
اگه بکاپ منو زدی پس این گزینه نیاز نیست، موقع آپدیت خودش تکراری‌هارو از حذف می‌کنه چون از داخل خود گروه گزینشو روشن کردم.

سومین کاری که باید بکنی زدن گزینه:  
🟡 `URL Test`  
هستش، حواست باشه قبل از انجام این تست وی‌پی‌ان هرچی که هست باید خاموش بشه وگرنه نتایج تست درست درنمیان.  

و آخرین کار اینه که گزینه:  
🔴 `Order / By Delay`  

رو بزن که کانفیگ‌ها به ترتیب بهتر بودن سرعت و پینگشون توی لیست قرار بگیرن، یکبار زدن این گزینه کافیه.
