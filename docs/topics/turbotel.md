...
- [**راه حل نه خیلی آسون** :rofl:](#دوم)
  - [نصب اپلیکیشن مدیریت فایل](#مدیریت-فایل)
  - [جایگزین کردن کد جدید](#کد)
  - [محتوای فایل بکاپ](#بکاپ)
- [توضیحات تکمیلی](#کش)
- [**همه‌چی درباره فایل‌های Cache در تلگرام**](#کش)
...
**حالا طبق اسکرین‌شات به ترتیب روی گزینه:**
- انتخاب همه
- جایگذاری
- ذخیره  
**کلیک کنید.**
...
وقتی از تلگرام استفاده می‌کنیم، برنامه برای اینکه سرعتش بالا باشه و هر بار لازم نباشه همه‌چیز رو از اینترنت دانلود کنه، یه سری فایل‌های کوچولوی بند‌انگشتی موقتی روی حافظه گوشی یا کامپیوتر ذخیره می‌کنه. به این فایل‌ها می‌گیم **Cache** یا همون حافظه پنهان.
...
- اینجا می‌تونی ببینی هر دسته از فایل‌ها (عکس، ویدیو، اسناد و...) چقدر فضا گرفتن.
...
<img width="1080" height="2212" alt="XMLTime" src="https://github.com/user-attachments/assets/0cd973a8-8bcd-4fc8-88cb-35d08f4d6863" />
