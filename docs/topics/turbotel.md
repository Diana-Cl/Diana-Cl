...
تنها کاری که لازمه بکنید یه **Clean Install** کردنه، یه نصب تر و تازه. جزئیات خاصی نداره و این چند سطر رو برای دوستان سالخورده خودم می‌نویسم چون ممکنه حواسشون نباشه. شما حرفه‌ای‌ها غلط کردید که بخونید اصلا لزومی نداره که بخونید توضیحات راه حل اول رو :smirk: :facepunch:
...
> پیشنهاد می‌کنم یک‌بار **Clear cache** هم بزنید براش نفسش باز بشه :satisfied:، اکه چیز خاصی درباره فایل‌های کش نمی‌دونی [دنبالم بیا داداش](#کش).
...
::: danger **نحوه عملکرد کش دیتابیس محلی**
...
- چرا؟؟ چون استفاده ام از تلگرام زیاده و روزانه فقط چند گیگ فایل دانلود و آپلود می‌کنم و حقیقتا بجز همون لحظه دیگه بهشون نیاز ندارم پس نمی‌خوام تلگرامم سنگین کار کنه و حافظه گوشیمم پر بشه واسه همین تعیین کردم اینطوری در فواصل کوتاه و خودکار پاک بشن.
...
و بعد روی **Add exception** برنید و مورد دل‌خواه رو به لیست اضافه کنید تا هیچ‌گونه فایل کشی از اون به‌طور خودکار پاک نشه.
...
<img width="1080" alt="XMLTime" src="https://github.com/user-attachments/assets/0cd973a8-8bcd-4fc8-88cb-35d08f4d6863" />
