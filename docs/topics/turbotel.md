...
### توضیحات غیرضروری
- [همه‌چیز درباره فایل‌های Cache تلگرام](#کش)
...
باشه چشم اصغر آقا شما امر کن :writing_hand:
...
پیشنهاد می‌کنم یک‌بار **Clear cache** هم بزنید براش نفسش باز بشه :satisfied:، اکه چیز خاصی درباره فایل‌های کش نمی‌دونی [دنبال من بیـا](#کش).
...
# همه‌چیز درباره فایل‌های Cache {#کش}
...
::: danger **`نحوه عملکرد کش لوکال دیتابیس`**
...
<br/>
<p align="center">
  <img src="/turbotel/12.png" alt="Slider" width="1080" height="484" />
</p>
:::
...
[^1]: گوشه سمت راستش آیکون کپی هست بزنید روش کپی میشه. <br/>
<img width="1080" height="2212" alt="XMLTime" src="/turbotel/13.png" />
