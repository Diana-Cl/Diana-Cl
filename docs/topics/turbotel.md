...
- [هرچیزی که نیازه درباره Cache تلگرام بدونیم](#کش)
...
تنها کاری که لازمه بکنید یه **Clean Install** کردنه، یه نصب تر و تازه. جزئیات خاصی نداره و این چند سطر رو برای دوستان سالخورده خودم می‌نویسم چون ممکنه حواسشون نباشه. شما حرفه‌ای‌ها غلط کردید بامن که بخونید اصلا لزومی نداره که بخونید این‌ها رو :smirk: :facepunch:
...
**رفع مشکل از طریق ایجاد فایل بکاپ از تنظیمات توربو**
...
::: tip **نحوه عملکرد Local DataBase Cache**
