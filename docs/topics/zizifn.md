...
## گام اول: فورک کردن ریپازیتوری (Fork) {#fork}
...
## گام دوم: دریافت اطلاعات لازم از کلودفلر {#token-time}
...
### ساخت API Token با دسترسی ویرایش ورکر {#api-token}
۱. **ورود به داشبورد کلادفلر:** وارد داشبورد Cloudflare شوید.   
- [ورود به کلادفلر][2]
...
## گام سوم: تنظیم سکرت‌ها در گیت‌هاب (GitHub Secrets) {#enviroments} 
...
## گام چهارم: فعال‌سازی و اجرای اکشن (Manual Deploy) {#manual-deploy}
...
۲. روی دکمه سبز رنگ **"I understand my workflows, go ahead and enable them"** کلیک کنید تا اکشن‌ها جهت اجرا مجاز شوند.  
