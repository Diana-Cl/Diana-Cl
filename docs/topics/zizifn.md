...
در این ساختار جدید نیازی به اضافه کردن کد‌های بی‌ارزش یا مبهم سازی‌های سنگین نداریم!۱
:::
...
::: danger نکته مهم
هردو متغیر اول (آیدی و توکن کلودفلر) اجباری هستند یعنی بدون دریافت این دو و قرار دادنشان در سکرت گیت‌هاب امکان دپلوی کردن وورکر وجود نخواهد داشت، ولی دو متغیر بعدی یعنی `UUID` و `PROXYIP` اختیاری هستند چون برای پروکسی آی‌پی یک مقدار پیشفرض داخل کد تعیین شده، و برای UUID اگر فیلد اونو خالی بگذارید اکشن گیت‌هاب خودش یک [UUID][4] جنریت کرده و به وورکر شما اختصاص میده. برای اطلاع از UUID ایجاد شده باید به داشبورد کلودفلر رفته و وارد وورکر مورد نظر شده و به تب تنظیمات داخل وورکر سر بزنید.
