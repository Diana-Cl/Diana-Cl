...
|:---------------:|:-----------------------|:---------------------------------|:---------------------------------|:---------------|
| **HWID**        | Windows 10-11          | Permanent                        | Yes                              | [Details](https://github.com/NiREvil/windows-activation/blob/main/docs/en/hwid.md) |
| **KMS**         | Windows 10-11          | 180 Days (Manual)               | Yes                              | [Details](https://github.com/NiREvil/windows-activation/blob/main/docs/en/kms.md) |
| **Ohook**       | Office                   | Permanent                         | No                              | -               |
| **TSforge**     | Windows / ESU / Office | Permanent                         | Yes (on build 19041+)          | [Details](https://github.com/NiREvil/windows-activation/blob/main/docs/en/tsforge.md) |
| **KMS38**       | Windows 10-11-Server   | Until 2038                        | No                               | [Details](https://github.com/NiREvil/windows-activation/blob/main/docs/en/kms38.md) |
| **Online KMS**  | Windows / Office       | 180 Days (Lifetime with Renewal) | Yes                              | [Details](https://github.com/NiREvil/windows-activation/blob/main/docs/en/kms.md) |
...
**Congratulations!** Your Windows is now permanently activated with a digital license. 
...
- **For Windows:** I personally use the **KMS method** ([see guide](https://github.com/NiREvil/windows-activation/blob/main/docs/en/kms.md)) for my Windows 10/11 activations. It's official, leaves no files on the system, and takes less than 3 minutes. If for some reason that fails, HWID is my go-to, as it's also official and file-less.  
